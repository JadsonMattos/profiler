...
from pro_filer.actions.main_actions import show_details  # specific.
from tests.actions import test_show_details  # specific
from tests.trybe import show_details_mocks  # specific
...
def test_assess_students_file_details(broken_asset: Callable):
...
@pytest.mark.dependency(
    depends=["test_assess_students_file_details"], include_all_instances=True
)
def test_assess_students_file_details_final():
    pass
